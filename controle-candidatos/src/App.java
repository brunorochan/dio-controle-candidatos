...
public class App {
    ...
    static void entrandoEmContato(String candidato){
        ...
        else System.out.println("NAO CONSEGUIMOS CONTATO COM " + candidato + ",NUMERO MAXIMO DE TENTATIVAS " + tentativasRealizadas + " ATINGIDA");
    ...
    static void imprimirSelecionados(){
        ...
        for(int indice = 0; indice < candidatos.length; indice++){
            System.out.println("O candidato de No. " + (indice+1) + " é o " + candidatos[indice]);
        }
